    ...
    <View>
      ...
      <Card>
        <View style={styles.cardItemView}>
          ...
          <View style={{marginLeft: '5%'}}>
            <Text style={{fontSize: 18, flex: 1}}>Bread and roasted meat</Text>
      ...
      <Card>
        <View style={styles.cardItemView}>
          ...
          />
          <View style={{marginLeft: '5%'}}>
            <Text style={{fontSize: 18, flex: 1}}>Bread and roasted fish</Text>
      ...
      <Card>
        <View style={styles.cardItemView}>
          ...
          />
          <View style={{marginLeft: '5%'}}>
            <Text style={{fontSize: 18, flex: 1}}>Bread and fried fish</Text>
      ...
      <Card>
        <View style={styles.cardItemView}>
          ...
          />
          <View style={{marginLeft: '5%'}}>
            <Text style={{fontSize: 18, flex: 1}}>Bread and fried meat</Text>
            <Text style={{fontWeight: 'bold'}}>Starting from ₦200</Text>
      ...
      <Card>
        <View style={styles.cardItemView}>
          ...
          />
          <View style={{marginLeft: '5%'}}>
            <Text style={{fontSize: 18, flex: 1}}>Bread and fried chicken</Text>
            <Text style={{fontWeight: 'bold'}}>Starting from ₦400</Text>
            <Text>sold 500, free delivery</Text>
            <Text>with cabbage and spices (optional)</Text>
          </View>
